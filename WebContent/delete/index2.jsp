...
<body>
		...
		<header>
			<div class = "wrapper">
				<nav>
					...
					<ul class = "menu">						
						<li><a  href="/bb/member/Login.jsp">로그인</a></li>
						<li><a  href="/bb/member/Form.jsp">회원가입</a></li>
					</ul>
		...
		<header>
			<nav class = "wrapper">
				<!-- <h1><img src="img/Koala.jpg" width="50" heigth="50" onclick="location.href='index.jsp'"></h1> -->
				<ul class="menu">
					<li><a href="/bb/board/All.jsp">전체</a></li>
					<li><a href="/bb/board/Me.jsp">나</a></li>
					<li><a href="/bb/board/Custom.jsp">맞춤</a></li>
					<li><a href="/bb/friend/Friend.jsp">친구</a></li>
					<li><a href="/bb/member/manage.jsp">회원 정보</a></li>									
				</ul>
			</nav>
		</header>
	<%}%>
