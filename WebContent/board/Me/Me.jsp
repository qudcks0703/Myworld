...
<jsp:include page="/logxx.jsp"></jsp:include>
	...
	<table>
		...
		%>
			...
			%>	
				<%for(int j=(4*i);j<b;j++){ //j=0; j<4 // j=4 ; j<8 4567
					...
					<img style="margin:10px;" width="180" height="180" src="/bb/board/upload/<%=bdto.getFile()%>"></a></td>
				<%} %>
				</tr>
		<% }%>
	</table>
		...
		<div class="fix1">
		<iframe src="/bb/friend/friendlist.jsp" width="400" height="550" style="border: none">
		</iframe>	
	</div>
</body>
</html>